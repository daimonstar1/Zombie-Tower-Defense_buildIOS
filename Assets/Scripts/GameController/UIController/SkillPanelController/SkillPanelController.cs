...
public class SkillPanelController : MonoBehaviour
{
  ...
  private void SetProgressTexture (int value, List<UITexture> listTexture)
  {
    ...
    for (int i = 0; i < value; i++) {
      listTexture [i].mainTexture = Resources.Load<Texture2D> ("Textures/UI/upgrade_progress_icon_enable1");
    }
  }
  ...
  {
    Master.Tutorial.CheckAndFinishTutorial (TutorialController.TutorialsIndex.UpgradeSkill);
