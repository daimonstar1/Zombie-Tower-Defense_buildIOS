...
public class UnitSelect : MonoBehaviour
{
	...
	public void SetInfo ()
	{
		...
		if (!isLock) {
			...
			iconSprite.transform.localScale = new Vector3 (55, 60, 60);
			iconSprite.transform.localPosition = new Vector3 (iconSprite.transform.localPosition.x, -11, 0);
	...
	public void OnTouchIn ()
	{
		...
		if (!isCanSelect || !Master.isGameStart)
			return;
	...
	void CheckCanSelect ()
	{
		...
		if (isLock || Master.Gameplay.isBlockUnitSelectByEnemy) {
			isCanSelect = false;
			return;
		}
