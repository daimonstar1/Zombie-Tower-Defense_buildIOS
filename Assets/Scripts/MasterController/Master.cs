		...
		if (instance == null) {
			...
			Firebase.FirebaseApp.CheckAndFixDependenciesAsync ().ContinueWith (task => {
				...
				if (dependencyStatus == Firebase.DependencyStatus.Available) {
					Debug.LogError ("Init firebase successfully!");
					System.TimeSpan sp = new System.TimeSpan (0, 10, 0);
					Firebase.Analytics.FirebaseAnalytics.SetSessionTimeoutDuration (sp);
				} else {
