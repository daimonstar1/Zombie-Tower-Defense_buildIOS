                            ...
                            if (listSequencesSelectOfWave[y])
                            {
                                ...
                                for (int z = 0; z < levelDataController.levelDataCollection.ListLevelData[i].ListWaves[y].ListSequences.Count; z++)
                                {
                                    ...
                                    if (listSequencesSelect[z])
                                    {
                                        ...
                                        levelDataController.levelDataCollection.ListLevelData[i].ListWaves[y].ListSequences[z].Time = float.Parse(EditorGUILayout.TextField("Time (second)", levelDataController.levelDataCollection.ListLevelData[i].ListWaves[y].ListSequences[z].Time.ToString(), options));
                                        EditorGUILayout.EndHorizontal();
